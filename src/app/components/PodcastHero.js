      ...
      <div className="flex-1">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {podcast.extra?.spotify_url && (
            <a
              href={podcast.extra.spotify_url}
              target="_blank"
              rel="noopener noreferrer"
          ...
          {podcast.extra?.youtube_url && (
            <a
              href={podcast.extra.youtube_url}
              target="_blank"
              rel="noopener noreferrer"
              className="bg-red-600 hover:bg-red-700 px-3 py-1 rounded text-white text-sm font-medium transition"
            >
              YouTube
            </a>
          )}
